proto:
		protoc -I proto/ proto/monitor.proto --go_out=plugins=grpc:proto/
		cp proto/github.com/headend/iptv-monitor-service/proto/monitor.pb.go proto/
build:
		protoc -I proto/ proto/monitor.proto --go_out=plugins=grpc:proto/
		cp proto/github.com/headend/iptv-monitor-service/proto/monitor.pb.go proto/
		GOOS=linux GOARCH=amd64 go build -o deployment/agent-service main.go
		docker build -t monitor-services-server deployments
run:
